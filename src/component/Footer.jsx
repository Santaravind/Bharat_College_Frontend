  ...
  return (
    <footer className="bg-white text-black footer">
      ...
      <div className="bg-white text-gray-900 py-4 text-center text-sm">
        <p>
          © 2025 <a href="" className="text-black font-semibold">BTCFSM</a>. All rights reserved. Theme <a href="https://www.happydigitalbharat.com/tech" className="text-black hover:text-blue-600" target="_blank" rel="noreferrer">Develop By Happy Digital Bharat </a> 

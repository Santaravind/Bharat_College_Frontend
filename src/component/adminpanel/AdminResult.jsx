...
const AdminResult = () => {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const obtainedMarks = allSubjects.reduce(
      ...
      const enhancedData = {
        ...
        session: data.Session || data.session || "",
        examinationCenter:
          data["Examination Center"] || data.examinationCenter || "", // ADD THIS
        ...
        subjects: subjectsWithWords.map((subject, index) => ({
          ...
          code:
            data.subjects?.[index]?.subjectCode ||
        ...
        certificateDate: formatDate(
          data["Issue Date"] || data.issueDate || new Date().toISOString(),
        ),
  ...
  <tr class="total-row">
    <td colspan="2" style="text-align: right; padding-right: 10px;">TOTAL / योग</td>
    <td>${result?.totalMarks || 0}</td>
    <td colspan="2"></td>
    <td><strong>${result?.obtainedMarks || 0}</strong></td>
    <td style="text-transform: uppercase; font-size: 9px;">${result?.totalInWords || ""}</td>
  </tr>
</tbody>
            </table>

             <!-- Grand Total    
              <div style=" text-align: right; font-weight: semi-bold;">
          ...
          >
            <div style={{ marginBottom: "1.5rem" }}>
              ...
              <p style={{ color: "#64748b" }}>
                Enter enrollment or serial number to view marksheet
              </p>
            </div>
            ...
            <form onSubmit={handleSearch}>
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "12px",
                    border:
                      searchType === "serial" ? "none" : "1px solid #d1d5db",
                    background:
                      searchType === "serial"
                        ? "linear-gradient(135deg, #2563eb, #4338ca)"
                        : "white",
              ...
              <div style={{ position: "relative", marginBottom: "1.5rem" }}>
                ...
                <input
                  ...
                  placeholder={
                    searchType === "enrollment"
                      ? "Enter Enrollment Number (e.g., ADM0XXXXX8720)"
                      : "Enter Serial Number (e.g., BT0XXXXXXX61905)"
                  }
                  style={{
                    width: "100%",
          ...
          {result && (
            <>
              <div
                style={{
                  background:
                    "linear-gradient(135deg, #fffef5 0%, #fefcf3 50%, #fffef5 100%)",
                  borderRadius: "12px",
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        AN AUTONOMOUS BODY UNDER GOVT. ACT • ESTABLISHED UNDER
                        ACT 1882
                      </p>
                      <h1
                        style={{
                ...
                <div style={{ padding: "2rem" }}>
                      ...
                      >
                        ...
                        <tbody>
                          ...
                          <tr
                            style={{
                              background:
                                "linear-gradient(135deg, #f8f4e8, #fffef5)",
                              fontWeight: "700",
                            }}
                          >
                            <td
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <h4 style={{ fontWeight: "700", color: "#1e293b" }}>
                          PERCENTAGE
                        </h4>
                        <Award
                          style={{
          ...
          {!result && !loading && (
            ...
            >
              ...
              <p style={{ color: "#64748b", marginBottom: "1rem" }}>
                Enter enrollment number or serial number to view the official
                marksheet
              </p>
              <p style={{ fontSize: "14px", color: "#94a3b8" }}>
                Demo: Try <strong>ADM0XXXXXX8720</strong> or{" "}
                <strong>BT01XXXXXXX5</strong>
              </p>
            </div>
          )}
        </div>
